...
function replaceImageURL($path)
{
    global $config;
    return str_replace('..', $config['base_url'], $path);
}
            ...
            <?php if($config['multiple_selection']){ ?><div class="selector">
                ...
                <div class="img-precontainer">
                    ...
                    <div class="img-container">
                        <img class="<?php echo $show_original ? "original" : "" ?><?php echo $is_icon_thumb ? " icon" : "" ?>" data-src="<?php echo replaceImageURL($src_thumb);?>">
                    </div>
                </div>
                <div class="img-precontainer-mini <?php if($is_img) echo 'original-thumb' ?>">
                    ...
                    <div class="img-container-mini">
                    <?php if($mini_src!=""){ ?>
                    <img class="<?php echo $show_original_mini ? "original" : "" ?><?php echo $is_icon_thumb_mini ? " icon" : "" ?>" data-src="<?php echo replaceImageURL($mini_src);?>">
                    <?php } ?>
                    </div>
                </div>
                ...
                <figcaption>
                    ...
                    <a class="tip-right preview" title="<?php echo trans('Preview')?>" data-featherlight="<?php echo replaceImageURL($src);?>"  href="#"><i class=" icon-eye-open"></i></a>
